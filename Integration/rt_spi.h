 ...
 * @param data 16bits to write in register
 */
int SPI_Write_32_CRC(int chip_select_pin, int SPI_mode, uint8_t target_register, uint8_t next_command, uint16_t data);
 ...
 * @param next_command next command input (idk)
 * @param data 16bits to read from register
 */
int SPI_Read_32_CRC(int chip_select_pin, int SPI_mode, uint8_t target_register, uint8_t next_command, uint16_t *data);
