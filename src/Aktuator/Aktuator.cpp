...
void Command_Magnetorquers(aktuator_data control_vector) {
  ...
  // }
  PWM_x = map(x_current, 0, _max_mA, 0, 180);
  PWM_y = map(y_current, 0, _max_mA, 0, 180);
  Serial.print(F("x pwm:"));
  Serial.println(PWM_x);
  Serial.print(F("y pwm:"));
